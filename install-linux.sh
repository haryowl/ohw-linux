...
# Galileosky Parser - One-Command Linux Installer
# Install from GitHub: curl -sSL https://raw.githubusercontent.com/haryowl/ohw-linux/main/install-linux.sh | bash
...
echo -e "${BLUE}🚀 Galileosky Parser - Linux Installer${NC}"
echo -e "${BLUE}=====================================${NC}\n"
...
if ! command -v git &> /dev/null; then
    ...
    echo -e "${YELLOW}Run: sudo apt-get update && sudo apt-get install -y git${NC}"
    exit 1
fi
